      ...
      <div className="flex flex-col h-full min-h-0">
        <div className="p-6 flex-1 min-h-0 overflow-y-auto">
          ...
          <div className="pt-6 mt-6 border-t border-slate-700 grid grid-cols-3 gap-2">
            ...
            <a href="mailto:fatimachoudhry94@gmail.com" className="flex items-center justify-center p-2 rounded-lg bg-slate-800 text-slate-400 hover:text-primary transition-colors" target="_blank" rel="noopener noreferrer" aria-label="Email">
