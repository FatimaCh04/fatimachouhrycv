...
function Home() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <section className="mt-4 md:mt-6 rounded-xl bg-slate-800/50 border border-slate-700 p-6 shadow-sm">
        <div className="flex flex-col items-center text-center">
          ...
          <p id="tagline-typed" className="text-base text-accent font-medium min-h-[1.25rem] mb-0 profile-tagline">|</p>
        </div>
      </section>
