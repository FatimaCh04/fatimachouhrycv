...
export const metadata = { title: 'Contact | Fatima Choudhry Portfolio' };
    ...
    <div className="space-y-8">
      <section className="rounded-xl bg-slate-800/50 border border-slate-700 p-10 shadow-sm">
        <h2 className="text-3xl font-extrabold text-white mb-4 flex items-center gap-2">
          <span className="material-symbols-outlined text-indigo-400">alternate_email</span>
          Contact
        </h2>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3 p-4 rounded-xl bg-slate-800 border border-slate-700">
                ...
                <div>
                  ...
                  <a href="mailto:fatimachoudhry94@gmail.com" className="text-indigo-400 hover:underline">fatimachoudhry94@gmail.com</a>
                </div>
              </li>
              <li className="flex items-center gap-3 p-4 rounded-xl bg-slate-800 border border-slate-700">
                <span className="flex items-center justify-center size-10 rounded-lg bg-slate-700 text-indigo-400 shrink-0">
                ...
                <div>
                  ...
                  <a href="https://github.com/FatimaCh04/FA23-BSE-123-5B-Fatima-Ch-" target="_blank" rel="noopener" className="text-indigo-400 hover:underline">GitHub</a>
                </div>
              </li>
              <li className="flex items-center gap-3 p-4 rounded-xl bg-slate-800 border border-slate-700">
                <span className="flex items-center justify-center size-10 rounded-lg bg-slate-700 text-indigo-400 shrink-0">
                ...
                <div>
                  ...
                  <a href="https://www.linkedin.com/in/fatima-choudhry-714423358/" target="_blank" rel="noopener" className="text-indigo-400 hover:underline">LinkedIn</a>
                </div>
              </li>
            </ul>
          </div>
      ...
      <section className="bg-indigo-500/20 border border-indigo-500 rounded-xl p-8 text-white text-center">
